...
void FullFitEmb_JP1_Levy(){

   TFile *f = new TFile("../BlueBeam_JP1Emb_xF_hists_modRange.root");
...
//For xF0 Data
   fitFcn->SetParameter(0,2.71820e+01); //levy amplitude
   fitFcn->SetParameter(1,3.30237e-01); //levy scale
   fitFcn->SetParameter(2,8.26052e-03);  //levy location
   fitFcn->SetParameter(3,4.59124e-02); //skgaus amplitude
   fitFcn->SetParameter(4,1.43081e-01); //skgaus mean
   fitFcn->SetParameter(5,4.01921e-02); //skgaus sigma
   fitFcn->SetParameter(6,1.45775e+01); //skgaus skewness   
