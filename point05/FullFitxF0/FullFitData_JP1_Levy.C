...
void FullFitData_JP1_Levy(){

   TFile *f = new TFile("../BlueBeam_JP1Data_xF_hists_modRange.root");
...
//For xF0 Data
   fitFcn->SetParameter(0,6.73284e+01); //levy amplitude
   fitFcn->SetParameter(1,2.49831e-01); //levy scale
   fitFcn->SetParameter(2,1.32916e-02);  //levy location
   fitFcn->SetParameter(3,4.83537e-02); //skgaus amplitude
   fitFcn->SetParameter(4,1.52022e-01); //skgaus mean
   fitFcn->SetParameter(5,4.04363e-02); //skgaus sigma
   fitFcn->SetParameter(6,1.33759e+01); //skgaus skewness   
