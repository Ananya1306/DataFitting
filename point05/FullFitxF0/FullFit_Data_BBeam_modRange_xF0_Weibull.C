...
void FullFit_Data_BBeam_modRange_xF0_Weibull(int range_input, int xF_input, string beam_input){
...
//For xF2 Data
   ...
   fitFcn->SetParameter(0,5.47968e-01); //weibull shape
   fitFcn->SetParameter(1,5.57240e-01); //weibull scale
   fitFcn->SetParameter(2,8.25867e-02);  //weibull location
   fitFcn->SetParameter(3,1.61930e+03); //weibull amplitude
   fitFcn->SetParameter(4,6.95451e+04); //skgaus amplitude
   fitFcn->SetParameter(5,1.49289e-01); //skgaus mean
   fitFcn->SetParameter(6,6.58667e-02); //skgaus sigma
   fitFcn->SetParameter(7,1.38106e+01); //skgaus skewness 
}
//For xF3 Data
else if(xF_input == 3){
