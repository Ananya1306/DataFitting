...
void FullFit_Data_BBeam_modRange_xF5bins_Levy(int range_input, int xF_input, string beam_input){
...
//For xF3 Data
   ...
   fitFcn->SetParameter(0,3.58241e+03); //levy amplitude 5399.85
   fitFcn->SetParameter(1,2.76694e-01); //levy scale 0.152805
   fitFcn->SetParameter(2,5.53567e-02);  //levy location 0.0678691
...
//For xF4 Data
  ...
  fitFcn->SetParameter(0,7.89815e+02); //levy amplitude
   ...
   h->Draw("ep");
//   if(xF_input == 3) {h->Fit("fitFcn","RW","ep");}
//   else{
   h->Fit("fitFcn","V+","ep");
//   } //V+ for xF0, xF1 and xF3; RW for xF2
   fitFcn->Draw("same");
