void codePreliminaryPlots_crossRatio(){
...
//	mgPi0->GetYaxis()->SetRangeUser(-0.02, 0.04);	
        TCanvas *c2 = new TCanvas("c2", "Pi0 AN Plot CrossRatio", 1000, 500);
...
//For pi0 AN plots
   ...
   // TLegendEntry *le3 = legend1->AddEntry((TObject*)0, "#bf{STAR Preliminary}", "C");
    TLegendEntry *le4 = legend1->AddEntry((TObject*)0, " Beam pol. err. 3.5%", "C"); //Blue 3.4%
  //  TLegendEntry *le5 = legend1->AddEntry((TObject*)0, "Yellow Beam pol. err. 3.5%", "C");
