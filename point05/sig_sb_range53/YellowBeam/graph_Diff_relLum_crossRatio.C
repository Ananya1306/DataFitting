...
/*    const std::string relLum_file = "aN_mod_indv_relLum_sb_goodChi2.txt";
    const std::string crossRatio_file = "aN_mod_indv_crossRatio_sb_goodChi2.txt";
*/
	...
	double xF_offset = 0.0065;
        // Store the values for plotting
        xF_vals.push_back(xF_val + xF_offset);
    ...
    grcrossRatio->SetMarkerStyle(21);
    grcrossRatio->SetMarkerSize(1.5);
    grcrossRatio->SetMarkerColor(807);
    grcrossRatio->SetLineColor(807);
    ...
    grBkgcrossRatio->SetMarkerStyle(21);
    grBkgcrossRatio->SetMarkerSize(1.5);
    grBkgcrossRatio->SetMarkerColor(807);
    grBkgcrossRatio->SetLineColor(807);
    ...
    mgBkg->SetTitle("Yellow Beam background asymmetry");
