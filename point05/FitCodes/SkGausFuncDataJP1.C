...
void SkGausFuncDataJP1(){
  ...
  // TF1 *fsg = new TF1("fsg",SkGausPeak,0.09,0.2,4);//pi0MxFPhi_0 fit function 
   TF1 *fsg = new TF1("fsg",SkGausPeak,0.125,0.25,4);//pi0MxFPhi_1 fit function 
  fsg->SetParameters(0.05,0.130,1,4); //pi0MxFPhi_0 fit initial parameters
