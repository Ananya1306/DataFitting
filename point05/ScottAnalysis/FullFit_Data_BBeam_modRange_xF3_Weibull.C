...
if(phi_val == 10){
   ...
   fitFcn->SetParameter(4,57.8698); //skgaus amplitude
   fitFcn->SetParameter(5,0.161597); //skgaus mean
   fitFcn->SetParameter(6,-0.0263945); //skgaus sigma
   fitFcn->SetParameter(7,63.6197); //skgaus skewness
}   
else {
   fitFcn->SetParameter(0,1.13618e+00); //weibull shape
   fitFcn->SetParameter(1,1.59102e-01); //weibull scale
  ...
  // fitFcnUp->FixParameter(4,fitFcn->GetParameter(4));
   ...
   int num_files = 6;
    ...
    for (int i = 0; i < num_files; ++i) {
        std::string filename = "BUp_pi0_bkg_xF3_range" + std::to_string(i) + ".txt";
    ...
    for (int i = 0; i < num_files; ++i) {
        std::string filename = "BDown_pi0_bkg_xF3_range" + std::to_string(i) + ".txt";
