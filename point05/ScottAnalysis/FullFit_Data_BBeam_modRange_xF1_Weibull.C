...
void FullFit_Data_BBeam_modRange_xF1_Weibull(int phi_val){
   ...
   TFile *f = new TFile("BlueBeamAllxF1.root");
...
//improve the picture
   ...
   signalFcn->Draw("same");
    ...
    TFile *fUp = new TFile("BlueBeamUpxF1.root");
...
//For xF0 Data
  ...
  // fitFcnUp->FixParameter(4,fitFcn->GetParameter(4));
   ...
   TFile *fDown = new TFile("BlueBeamDownxF1.root");
...
//For xF0 Data
  ...
  // fitFcnUp->FixParameter(4,fitFcn->GetParameter(4));
   ...
   ofstream outfile;
   outfile.open("Par_BB_xF1.txt",std::ios::app);
   ...
   int num_files = 6;
    ...
    for (int i = 0; i < num_files; ++i) {
        std::string filename = "BUp_pi0_bkg_xF1_range" + std::to_string(i) + ".txt";
    ...
    for (int i = 0; i < num_files; ++i) {
        std::string filename = "BDown_pi0_bkg_xF1_range" + std::to_string(i) + ".txt";
